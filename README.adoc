...
To do any sort of join, I find helpful to think of it as a 3 step process:app-name: 
...
image::https://user-images.githubusercontent.com/63274055/148324695-4b6b9200-1b85-41fa-88bf-54599179d5ee.png[width=200]
